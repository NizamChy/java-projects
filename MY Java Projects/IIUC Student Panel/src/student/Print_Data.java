...
class Print_Data implements ActionListener {
    ...
    String std_id, name, father, address, phone, email, college, dept, age, dob, semester;
    JButton b1, b2;
    ImageIcon icon;
    ...
    Print_Data(String e_id) {
        try {
            conn con = new conn();
            String str = "select * from student where std_id = '" + e_id + "'";
        ...
        id9.setLayout(null);
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("student/icons/print.jpg"));
        id9.setIcon(img);
