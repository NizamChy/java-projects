...
class Update_Student extends Add_Student implements ActionListener {
    ...
    Update_Student(String idaa) {
        ...
        id15.setLayout(null);
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("student/icons/add_student.jpg"));
        id15.setIcon(img);
        ...
        id1.setFont(new Font("serif", Font.BOLD, 22));
        id15.add(id1);
        ...
        id2.setFont(new Font("serif", Font.BOLD, 21));
        id15.add(id2);
        ...
        id3.setFont(new Font("serif", Font.BOLD, 22));
        id15.add(id3);
        ...
        id5.setFont(new Font("serif", Font.BOLD, 22));
        id15.add(id5);
        ...
        id6 = new JLabel("College:");
        id6.setBounds(400, 200, 100, 30);
        id6.setForeground(Color.white);
        id6.setFont(new Font("serif", Font.BOLD, 22));
        id15.add(id6);
        ...
        id7.setFont(new Font("serif", Font.BOLD, 18));
        id15.add(id7);
        ...
        id9 = new JLabel("Semester:");
        id9.setBounds(400, 250, 100, 30);
        id9.setFont(new Font("serif", Font.BOLD, 22));
        id15.add(id9);
        ...
        id10.setFont(new Font("serif", Font.BOLD, 22));
        id15.add(id10);
        f.setVisible(false);
        t9 = new JTextField();
    ...
    void showData(String s) {
        try {
            conn con = new conn();
            String str = "select * from student where std_id = '" + s + "'";
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == b && i == 1) {
            try {
                conn con = new conn();
                String str = "update student set name='" + t1.getText() + "',fname='" + t2.getText() + "',age='" + age + "',dob='" + dat + "',address='" + t3.getText() + "',phone='" + t4.getText() + "',email='" + t5.getText() + "',college='" + t6.getText() + "',dept='" + t7.getText() + "',semester='" + t8.getText() + "',std_id='" + t9.getText() + "' where std_id='" + id_emp + "'";
